          ...
          <div className="flex items-center gap-1 bg-gray-100 p-1 rounded-lg">
            <button
              ...
              className={`p-2 rounded-md transition-colors ${
                viewMode === "grid"
                  ? "bg-white shadow-sm text-[#0064FA]"
      ...
      {filteredProjects.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {filteredProjects.map((project) => (
            <div
              key={project.id}
              className={`bg-white rounded-xl border border-gray-200 hover:border-[#0064FA]/50 hover:shadow-lg transition-all cursor-pointer group ${
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg bg-white text-gray-900 focus:ring-2 focus:ring-[#0064FA] focus:border-transparent outline-none"
                    autoFocus
                  />
                </div>
