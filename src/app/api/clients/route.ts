...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log("[API /clients] Fetching clients with params:", { page, perPage, search, status, sortBy, sortOrder })
    ...
    console.log("[API /clients] Found:", { clientsCount: clients.length, total, activeCount, prospectCount, inactiveCount })
