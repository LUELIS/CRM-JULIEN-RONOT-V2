...
import { Loader2, Mail, Lock, Zap, ArrowRight, AlertCircle, User } from "lucide-react"
      ...
      <div className="w-full max-w-md">
        ...
        >
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl mb-4" style={{ background: "#E6F0FF" }}>
              <User className="w-6 h-6" style={{ color: "#0064FA" }} />
            </div>
            <h2 className="text-xl font-semibold mb-1" style={{ color: "#111111" }}>
              Connexion Client
            </h2>
            <p className="text-sm" style={{ color: "#999999" }}>
              Accédez à vos factures et devis
            </p>
          </div>
